create table Salesman1(Salesman_Id  int,
                        Customer_Name varchar(50),
						City varchar(50),
						Comission decimal,						
						);

						insert into Salesman1 values(1,'Monu','Nagpur',15),
...
create table Orders9(Order_No int,
                     Purchase_Amount int,
					 Order_Date date,
					 Customer_Id int,
					 Salesman_Id int,
					 ...
					 insert into Orders9 values(11,300,'2023-11-01',111,1),
...
SELECT Order_No , Purchase_Amount ,Order_Date ,Customer_Id ,Salesman_Id  FROM Orders9
