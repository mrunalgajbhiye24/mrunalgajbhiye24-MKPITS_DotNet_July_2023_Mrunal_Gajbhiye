create table ProductQty2(Product_Id int,
                        Region varchar(50),
						...
						insert into ProductQty2 values(1,'East','Computer',2012,'2',90000),
...
select * from ProductQty2

select Product_Name,MIN(Price) As "Minimum Price"
from ProductQty2
